...
const Contact = () => {
   ...
   const sendEmail = (e) => {
     ...
     emailjs.sendForm('service_fnlyk4i', 'template_b1c5jwj', form.current, 'zACzMzsFyBJCvFwsk')
       e.target.reset()
            ...
            <div className="contact__info">
               <div className="contact__card">
                  ...
                  <h3 className="contact__card-title">Email</h3>
                     ...
                     <a href="mailto:hayden10beb@gmail.com" className="contact__button">Write me {" "} <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
               ...
               <div className="contact__card">
                  ...
                  <h3 className="contact__card-title">Whatsapp</h3>
                     ...
                     <a href="https://api.whatsapp.com/send?phone=+2348159840013&text=Hello Adeleye," className="contact__button">Write me {" "} <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
